 ...
 * Roles con gestión: admin, jefe_planta, mantencion, supervisor
 * Roles limitados (laboratorio, produccion, planificacion, bodega_materias_primas, logistica_bodega) solo pueden crear OT y ver calendario
 */
