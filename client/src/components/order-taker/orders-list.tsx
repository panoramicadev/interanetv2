...
import { CalendarIcon, Search, FileText, Users, TrendingUp } from "lucide-react";
              ...
              {filterType === "day" ? (
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      variant="outline"
                      className="flex-1 lg:w-52 justify-start text-left font-normal rounded-xl border-gray-200 shadow-sm text-sm min-w-0"
                ...
                <div className="flex items-center space-x-2 flex-1 min-w-0">
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button
                        variant="outline"
                        className="flex-1 min-w-0 justify-start text-left font-normal rounded-xl border-gray-200 shadow-sm text-sm"
                ...
                <Select value={selectedYear.toString()} onValueChange={(value) => setSelectedYear(parseInt(value))}>
                  <SelectTrigger className="flex-1 lg:w-52 rounded-xl border-gray-200 shadow-sm text-sm min-w-0" data-testid="select-year">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent className="rounded-xl border-gray-200">
                ...
                <Select value={selectedPeriod} onValueChange={setSelectedPeriod}>
                  <SelectTrigger className="flex-1 lg:w-52 rounded-xl border-gray-200 shadow-sm text-sm min-w-0" data-testid="select-period">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent className="rounded-xl border-gray-200">
                          ...
                          <TableCell className="py-4">
                            <div className="flex items-center space-x-3">
                              ...
                              <div className="min-w-0 flex-1">
                                <div className="font-medium text-gray-900 text-base truncate">{sale.customerName}</div>
                        ...
                        {isExpanded && sale.transactions.map((transaction, index) => (
                          ...
                          >
                            ...
                            <TableCell className="text-right text-sm font-medium text-gray-700">
                              {formatCurrency(Number(transaction.monto) || Number(transaction.vanedo) || 0)}
                            </TableCell>
                          </TableRow>
                        ))}
                      </React.Fragment>
