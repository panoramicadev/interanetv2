                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full pr-2 sm:pr-4 gap-2">
                      ...
                      <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                        ...
                        <div className="text-left min-w-0 flex-1">
                          <div className="font-semibold text-sm sm:text-base text-gray-900 dark:text-gray-100 break-words line-clamp-2 sm:truncate">{salespersonGroup.salespersonName}</div>
                      ...
                      <div className="grid grid-cols-2 gap-3 sm:flex sm:items-center sm:gap-4 shrink-0 w-full sm:w-auto">
                          ...
                          >
                            <AccordionTrigger className="px-2 sm:px-3 py-1.5 sm:py-2 hover:bg-gray-50 dark:hover:bg-gray-800">
                              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full pr-2 sm:pr-4 gap-2">
                                ...
                                <div className="text-left min-w-0 flex-1">
                                  <div className="font-medium text-xs sm:text-sm text-gray-900 dark:text-gray-100 break-words line-clamp-2 sm:truncate">{clientGroup.clientName}</div>
                                  <div className="text-xs text-gray-500 dark:text-gray-400">
