            ...
            <CollapsibleTrigger className="w-full p-4 sm:p-5 flex items-center justify-between hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors" data-testid="trigger-pending-docs">
                <div className="flex items-center gap-3 sm:gap-4">
                    <div className="relative">
                        <div className="bg-[#fd6301] rounded-xl p-2.5 shadow-md shadow-[#fd6301]/25">
                            <ShoppingCart className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                        </div>
                        {/* Small GDV indicator dot */}
                        <div className="absolute -bottom-0.5 -right-0.5 bg-[#0a0a0a] rounded-full w-3 h-3 border-2 border-white dark:border-gray-900" />
                    </div>
                    <div className="text-left">
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                            <span className="text-sm font-semibold text-[#fd6301]">
                ...
                <div className="flex items-center gap-2">
                    <div className="hidden sm:flex gap-1.5">
                        <Badge variant="outline" className="bg-orange-50 dark:bg-orange-950/30 text-[#fd6301] border-orange-200 dark:border-orange-800 text-xs">
                            {nvvTotalOrders} NVV
                        </Badge>
                        <Badge variant="outline" className="bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 border-slate-300 dark:border-slate-700 text-xs">
                            {gdvTotalGuias} GDV
                        </Badge>
                    </div>
                        ...
                        <div className="px-4 sm:px-5 pt-4">
                            <TabsList className="grid w-full grid-cols-2 h-10">
                                <TabsTrigger value="nvv" className="flex items-center gap-2 text-sm font-medium">
                                    ...
                                    <Badge variant="secondary" className="ml-1 text-xs px-1.5 py-0 h-5 bg-orange-50 text-[#fd6301] dark:bg-orange-950/30 dark:text-orange-300">
                                        {nvvTotalOrders}
                                    </Badge>
                                </TabsTrigger>
                                <TabsTrigger value="gdv" className="flex items-center gap-2 text-sm font-medium">
                                    ...
                                    <Badge variant="secondary" className="ml-1 text-xs px-1.5 py-0 h-5 bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-200">
                                        {gdvTotalGuias}
                                    </Badge>
                                </TabsTrigger>
                            </TabsList>
                                                        ...
                                                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full pr-2 gap-1.5">
                                                            ...
                                                            <div className="flex gap-4 shrink-0">
                                                                <div className="text-left sm:text-right">
                                                                    ...
                                                                    <div className="font-semibold text-sm text-slate-700 dark:text-slate-200">{formatNumber(sp.totalUnits)}</div>
                                                                </div>
                                                                <div className="text-left sm:text-right">
                                                                    <div className="text-[10px] sm:text-xs text-gray-500">Monto</div>
                                                                    <div className="font-bold text-sm text-[#fd6301] dark:text-orange-300">{formatCurrency(sp.totalAmount)}</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </AccordionTrigger>
                                                                            ...
                                                                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full pr-2 gap-1">
                                                                                ...
                                                                                <div className="flex gap-3 shrink-0">
                                                                                    <div className="text-left sm:text-right">
                                                                                        ...
                                                                                        <div className="text-sm font-semibold text-slate-700 dark:text-slate-200">{formatNumber(cg.totalUnits)}</div>
                                                                                    </div>
                                                                                    <div className="text-left sm:text-right">
                                                                                        <div className="text-xs text-gray-500">Monto</div>
                                                                                        <div className="text-sm font-bold text-[#fd6301] dark:text-orange-300">{formatCurrency(cg.totalAmount)}</div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </AccordionTrigger>
                                                                                ...
                                                                                {cg.records.map((r) => (
                                                                                    <div key={r.id} className="bg-white dark:bg-slate-900 rounded border dark:border-gray-700 p-2 text-xs">
                                                                                        <div className="flex justify-between items-start mb-1">
                                                                                            ...
                                                                                            <Badge variant="outline" className="bg-orange-50 dark:bg-orange-950/30 text-[#fd6301] dark:text-orange-300 border-orange-200 text-xs shrink-0">
                                                                                        ...
                                                                                        <div className="text-gray-600 dark:text-gray-400">
                                                                                            ...
                                                                                            <div className="flex gap-2 mt-0.5">
                                                                                                ...
                                                                                                <span className="font-semibold text-[#fd6301] dark:text-orange-300"><span className="font-medium">Pend:</span> {formatNumber(r.cantidadPendiente)}</span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                ))}
                                                    ...
                                                    <AccordionTrigger className="px-3 py-2.5 hover:bg-gray-50 dark:hover:bg-gray-800 hover:no-underline">
                                                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full pr-2 gap-1.5">
                                                            ...
                                                            <div className="flex gap-4 shrink-0">
                                                                ...
                                                                <div className="text-left sm:text-right">
                                                                    <div className="text-[10px] sm:text-xs text-gray-500">Monto</div>
                                                                    <div className="font-bold text-sm text-slate-700 dark:text-slate-200">{formatCurrency(sp.totalAmount)}</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </AccordionTrigger>
                                                                        ...
                                                                        <AccordionTrigger className="px-2 py-1.5 hover:bg-gray-50 dark:hover:bg-gray-800 text-sm">
                                                                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full pr-2 gap-1">
                                                                                ...
                                                                                <div className="flex gap-3 shrink-0">
                                                                                    ...
                                                                                    <div className="text-left sm:text-right">
                                                                                        <div className="text-xs text-gray-500">Monto</div>
                                                                                        <div className="text-sm font-bold text-slate-700 dark:text-slate-200">{formatCurrency(cg.totalAmount)}</div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </AccordionTrigger>
                                                                                ...
                                                                                {cg.records.map((r, idx) => (
                                                                                    <div key={`${r.numeroGuia}-${idx}`} className="bg-white dark:bg-slate-900 rounded border dark:border-gray-700 p-2 text-xs">
                                                                                        <div className="flex justify-between items-start mb-1">
                                                                                            ...
                                                                                            <Badge variant="outline" className="bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 border-slate-300 text-xs shrink-0">
                                                                                        ...
                                                                                        <div className="text-gray-600 dark:text-gray-400">
                                                                                            ...
                                                                                            <div className="mt-0.5">
                                                                                                <span className="font-semibold text-slate-700 dark:text-slate-200">Cantidad: {formatNumber(r.cantidad)}</span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                ))}
