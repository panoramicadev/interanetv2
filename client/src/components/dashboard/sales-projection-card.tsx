...
import { TrendingUp, TrendingDown, Minus, BarChart3, Calendar, Target, ArrowUpRight, ArrowDownRight, Activity } from "lucide-react";
...
export default function SalesProjectionCard({ selectedPeriod, filterType, segment, salesperson, client }: SalesProjectionCardProps) {
  const { data, isLoading } = useQuery<ProjectionData>({
    queryKey: ['/api/sales/projection-insight', selectedPeriod, filterType, segment, salesperson, client],
    queryFn: async () => {
  ...
  const progressPct = data.totalDays > 0 ? Math.min((data.elapsedDays / data.totalDays) * 100, 100) : 0;
    ...
    <div className="modern-card p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row lg:items-start gap-4 lg:gap-8">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-500 dark:text-gray-400">
                Basado en análisis de últimos 12 y 6 meses
              </p>
            </div>
          </div>
        ...
        <div className="flex-shrink-0 w-full lg:w-72 space-y-3">
          {data.methodology !== 'actual' && (
            <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-3">
              <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 mb-1.5">
                ...
                <span className="font-semibold">{data.elapsedDays}/{data.totalDays} días</span>
              </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-3">
            <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 mb-1.5">
              <span>Venta actual vs proyección</span>
          ...
          {data.samePeriodLastYear !== null && (
            <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-2.5 text-center">
              <p className="text-[10px] text-gray-500 dark:text-gray-400 font-medium mb-0.5">Mismo período año anterior</p>
