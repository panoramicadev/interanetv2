            ...
            {sidebarItems.map((item, index) => {
              ...
              return (
                <div key={item.href}>
                  ...
                  ) : (item as any).isExternalCatalog && (user as any)?.publicSlug ? (
                    // External catalog link for salesperson
                    <a 
                      href={`/catalogo/${(user as any).publicSlug}`}
                      target="_blank"
                  ...
                  ) : (item as any).isExternalCatalog ? null : (
                    ...
                    <Link href={item.href}>
                      <Button
                        ...
                        className={`w-full justify-start relative ${
                          ...
                          isActive && item.href === '/notificaciones'
                            ? "bg-gradient-to-r from-amber-500/20 to-orange-500/20 text-amber-300 border-amber-400/60"
                            : isActive
