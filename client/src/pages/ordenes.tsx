...
import { CalendarIcon, Search, FileText, Users, TrendingUp, ArrowLeft } from "lucide-react";
  ...
  useEffect(() => {
    switch (filterType) {
      case "day":
        ...
        break;
      case "month":
        // Always load current month when in month view
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-between px-4 py-4 border-t">
                <p className="text-sm text-gray-700">
                  Mostrando {(currentPage - 1) * itemsPerPage + 1} a {Math.min(currentPage * itemsPerPage, allGroupedSales.length)} de {allGroupedSales.length} órdenes
                </p>
