              ...
              {!isComparativeMode && (
                <div className="pt-2">
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-emerald-50 to-green-50 border-2 border-emerald-400 hover:border-emerald-500 hover:from-emerald-100 hover:to-green-100 text-emerald-700 font-semibold shadow-sm hover:shadow-md transition-all duration-300 animate-pulse"
