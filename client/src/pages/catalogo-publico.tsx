    ...
    <div className="h-screen flex flex-col bg-slate-50 overflow-hidden">
      ...
      <header className="relative bg-slate-900 overflow-hidden border-b border-white/5 flex-shrink-0">
        <div className="absolute inset-0">
          <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-amber-500/10 rounded-full blur-[80px] -translate-y-1/2 translate-x-1/2"></div>
        ...
        <div className="relative container mx-auto px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="relative flex-shrink-0">
              <div className="w-10 h-10 rounded-xl overflow-hidden border-2 border-white/10 bg-gradient-to-br from-slate-800 to-slate-700 flex items-center justify-center">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 flex-wrap">
                <h2 className="text-sm font-bold text-white truncate" data-testid="salesperson-name">
                  {clientBusinessName || salesperson.salespersonName}
                </h2>
                {clientBusinessName && clientLoyaltyTier && (
                  <Badge className={`${getTierBadgeColor(clientLoyaltyTier.code)} border-none px-1.5 py-0 text-[8px] font-bold uppercase`}>
