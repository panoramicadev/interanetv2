...
export const stgMaeddo = ventasSchema.table("stg_maeddo", {
  ...
  caprad: numeric("caprad", { precision: 18, scale: 4 }),
  caprex: numeric("caprex", { precision: 18, scale: 4 }),
  nulido: text("nulido"),
  sulido: text("sulido"),
  ...
  vabrli: numeric("vabrli", { precision: 18, scale: 4 }),
  ...
  logistica: numeric("logistica", { precision: 18, scale: 4 }),
  eslido: text("eslido"),
...
// Staging: TABSU (Sucursales)
export const stgTabsu = ventasSchema.table("stg_tabsu", {
  kosu: text("kosu").primaryKey(),
  nokosu: text("nokosu"),
});

// Staging: TABZO (Zonas)
export const stgTabzo = ventasSchema.table("stg_tabzo", {
  kozo: text("kozo").primaryKey(),
  nokozo: text("nokozo"),
});

// Staging: TABFU (Vendedores/Funcionarios) - nombres descriptivos
export const stgTabfu = ventasSchema.table("stg_tabfu", {
  kofu: text("kofu").primaryKey(),
  nokofu: text("nokofu"),
});

// Staging: TABFM (Familia de productos)
export const stgTabfm = ventasSchema.table("stg_tabfm", {
  kofm: text("kofm").primaryKey(),
  nokofm: text("nokofm"),
});

// Staging: TABPF (Precio Familia)
export const stgTabpf = ventasSchema.table("stg_tabpf", {
  kopf: text("kopf").primaryKey(),
  nokopf: text("nokopf"),
});

// Staging: TABHF (Jerarquía Familia)
export const stgTabhf = ventasSchema.table("stg_tabhf", {
  kohf: text("kohf").primaryKey(),
  nokohf: text("nokohf"),
});
...
export const factVentas = ventasSchema.table("fact_ventas", {
  ...
  nusepr: text("nusepr"),
  koprct: text("koprct"),
  udtrpr: numeric("udtrpr", { precision: 18, scale: 4 }),
  rludpr: numeric("rludpr", { precision: 18, scale: 4 }),
  caprco1: numeric("caprco1", { precision: 18, scale: 4 }),
  caprad1: numeric("caprad1", { precision: 18, scale: 4 }),
  caprex1: numeric("caprex1", { precision: 18, scale: 4 }),
